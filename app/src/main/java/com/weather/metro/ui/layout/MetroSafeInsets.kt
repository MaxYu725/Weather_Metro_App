 ...
 *
 * Primary Current / Forecast / Settings pivots intentionally do not use this modifier:
 * they are non-interactive identity typography and use their own fixed top rhythm.
 */
@Composable
